...
- [ ] The optional blue indicator is disabled by default; when enabled, it tracks the current pointer location within one display refresh after entering free mode. I/J/K/L move up/left/down/right, including diagonals and opposing directions.
