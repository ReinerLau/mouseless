...
func run() -> Int32 {
  ...
  do {
    ...
    guard let schemaVersion = generated["schemaVersion"] as? Int, schemaVersion == 1 else {
      print("FAIL: generated configuration has no schemaVersion 1.")
      return 1
    }
    print("PASS: first launch generated config.json with schemaVersion 1.")
