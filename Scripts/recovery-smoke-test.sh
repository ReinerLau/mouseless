...
3. Enter free mode, revoke Accessibility permission in System Settings, then
   return to Keyveer.
4. Re-grant Accessibility, enter free mode, and use the event tap normally.
